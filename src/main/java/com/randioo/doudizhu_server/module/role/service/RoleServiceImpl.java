...
public class RoleServiceImpl extends ObserveBaseService implements RoleService {
    ...
    public void initRoleDataFromHttp(Role role) {
        ...
        // HttpConnection(GlobleConfig.String("URL")
        // +
        // "/gateway/MaJiang/getMoney.php?key=f4f3f65d6d804d138043fbbd1843d510&&id=",
        // role.getAccount());
        //
        // JSONObject obj = null;
        // try {
        ...
        role.setName(StringUtils.isNullOrEmpty(name) ? "guest" + role.getAccount() : name);
